package Modulo6_Construtores_Pacotes_Visibilidade.Aula9_OrganizandoClassesEmPacotes.com.algaworks.erp.comercial.Aula9_OrganizandoClassesEmPacotes.com.algaworks.erp.estoque;

import java.util.Objects;
import java.util.UUID;

public class ProdutoAula9 {
    ...
    ProdutoAula9(String nome){
        this(nome,QUANTIDADE_ESTOQUE_INICIAl);

    }

    ProdutoAula9(String nome, int estoqueInicial){
